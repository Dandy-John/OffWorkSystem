...
<script>
    function submitForm() {
        ...
        if (username == '') {
            ...
            $.post("/off_work_system/user/api/login", {'username' : username, 'password' : password}, function(result){
                if (result.state == 200) {
                    alert("登录成功");
            ...
            <div class="col-md-offset-3 col-md-6">
                <form class="form-horizontal" id="loginForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="button" onclick="submitForm()" class="btn btn-default" value="登录" />
                    </div>
                </form>
            </div>
        </div>
